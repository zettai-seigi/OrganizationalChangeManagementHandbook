...
| Activity | OCM Practice Lead | Project OCM Lead | Project Manager | Business Sponsor |
|----------|------------------|------------------|-----------------|------------------|
| OCM Methodology | A/R | C | I | I |
| OCM Plan Development | C | A/R | C | A |
| Stakeholder Assessment | C | A/R | I | C |
| Communication Execution | I | A/R | C | C |
| Training Delivery | C | A/R | C | I |
| Adoption Measurement | C | A/R | I | A |
| Readiness Decision | C | R | R | A |
...
| Decision Type | Decision Maker | Input Required |
|---------------|---------------|----------------|
| OCM methodology standards | OCM Practice Lead | CoE, CoP |
| Project OCM approach | Project OCM Lead | Business Sponsor, PM |
| OCM resource allocation | Project Manager/Sponsor | OCM Lead |
| Communication content | Project OCM Lead | Business Sponsor, Legal |
| Training approach | Project OCM Lead | Training, SMEs |
| Go-live readiness | Business Sponsor | OCM Lead, PM |
| Resistance escalation | Sponsor | OCM Lead, HR |
| OCM policy exceptions | OCM Practice Lead | Steering Committee |
...
| Factor | Level 1 (Light) | Level 2 (Standard) | Level 3 (Intensive) |
|--------|-----------------|--------------------|--------------------|
| Impacted users | <100 | 100-1000 | >1000 |
...
|--------|----------|-----------|
| Project OCM Status | Project Team, Sponsor | Weekly |
...
| Previous | Next |
|----------|------|
| [Chapter 14: Maturity Model](/OrganizationalChangeManagementHandbook/chapters/14-maturity-model/) | [Chapter 16: Policies and Standards](/OrganizationalChangeManagementHandbook/chapters/16-policies-standards/) |
