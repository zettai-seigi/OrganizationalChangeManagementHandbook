---
layout: default
title: "Chapter 4: Change Readiness Assessment"
parent: "Part II: Assessment and Planning"
nav_order: 1
permalink: /chapters/04-readiness-assessment/
---
...
**Defer or Cancel**: Remove lower-priority initiatives from the portfolio
**Sequence**: Stagger initiatives to avoid overlapping peak demands
**Integrate**: Combine related changes into unified initiatives
**Reduce Scope**: Scale back change scope to reduce demands
**Increase Capacity**: Add resources to expand absorption capacity
**Prioritize Stakeholders**: Focus limited capacity on highest-impact groups
