...
**Step 1: Select Representative Roles**
Choose roles that represent significant impacted populations. Focus on roles with high impact or high numbers.

**Step 2: Document Current Day**
Describe a typical current workday hour by hour:
...
**Step 3: Document Future Day**
Describe the same day after the change:
...
Call out the significant differences:
...
**Impact by Group**
For each impacted stakeholder group:
...
| Previous | Next |
|----------|------|
| [Chapter 5: Stakeholder Analysis](/OrganizationalChangeManagementHandbook/chapters/05-stakeholder-analysis/) | [Chapter 7: OCM Strategy and Planning](/OrganizationalChangeManagementHandbook/chapters/07-strategy-planning/) |
