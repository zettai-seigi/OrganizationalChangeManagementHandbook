...
| Assessment Type | Standard Requirements |
|-----------------|----------------------|
| Stakeholder Analysis | All impacted groups identified; Power/Interest mapping completed |
| Impact Assessment | Process, role, skill impacts documented; Severity assessed |
| Readiness Assessment | All dimensions evaluated; Gaps identified; Action plans documented |

**Communication Standards**

| Element | Standard |
|---------|----------|
| Message Development | Key messages documented; WIIFM addressed for each audience |
| Approval | Communications approved per matrix before distribution |
| Timing | Managers briefed before employees |
| Feedback | Two-way mechanism included |

**Training Standards**

| Element | Standard |
|---------|----------|
| Design | Role-based design; Clear learning objectives |
| Content | Job-relevant scenarios; Hands-on practice included |
| Delivery | Training scheduled within 2-4 weeks of go-live |
| Assessment | Proficiency assessed post-training |
...
| Previous | Next |
|----------|------|
| [Chapter 15: Governance Framework](/OrganizationalChangeManagementHandbook/chapters/15-governance/) | [Chapter 17: Implementation Roadmap](/OrganizationalChangeManagementHandbook/chapters/17-implementation-roadmap/) |
